 ...
 */
 ...
 $string['cm_intro']    = '<p align="left">Please choose the course shells you would like to create from the listing below. When finished selecting your course shells use the "Create Course" button below this section.</p>';
 ...
 $string['er_mname']    = 'Meta Course Name does not meet requirements';
...
characters long (containing only letters and numbers).</p>';
 ...
 $string['metanameabout_help'] = '<p>The Meta Course Name is the name that this course will be registerd in the moodle system. Parts of the Meta Course Name are auto generated by the moodle system.</p><p>Example: <br>Spring 2013 &lt;userid&gt; Meta &lt;your string&gt;</p><p>Directions: Place the desired title for your course in the box to the right (e.g., MUHI 101 or Introduction to Music). Titles can be a maximum of 45 characters long (containing only letters, numbers, and spaces).</p>';
